...
config_dir = ("/home/ubercow/.config/awesome")
...
tags = {}
for s = 1, screen.count() do
    tags[s] = awful.tag({ "main", "term", "web", "game", "music" }, s, layouts[2])
end
...
--vicious.register(mpdwidget, vicious.widgets.mpd,
  --function (musicwidget, args)
    --if args["{state}"] == "Stop" then
      --return '<span background="'..base3..'" font="Menlo 12"><span color="'..violet..'">'..larrow..'</span></span><span background="'..violet..'" font="Menlo 12"><span font="Menlo 10" color="'..base2..'">'..musicicon..' </span></span>'
    --else
      --return '<span background="'..base3..'" font="Menlo 12"><span color="'..violet..'">'..larrow..'</span></span><span background="'..violet..'" font="Menlo 12"><span font="Menlo 10" color="'..base2..'">'..musicicon..args["{Artist}"]..'-'args["{Title}"]..'</span></span>'
    --end
  --end, 10)
...
--    if args["{state}"] == "Stop" then
--	return '<span background="'..base2..'" font="Menlo 12"><span color="'..violet..'">'..larrow..'</span></span><span background="'..violet..'"><span color="'..blue..'" font="Menlo 12">'..larrow..'</span></span>'
--    elseif args["{state}"] == "Pause" then
--        return '<span background="'..base3..'" font="Menlo 12"><span color="'..violet..'">'..larrow..'</span></span><span background="'..violet..'"><span color="'..base3..'" font="Menlo 10">'..musicicon.. ' ' ..'</span></span><span background="'..violet..'"><span color="'..blue..'" font="Menlo 12">'..larrow..'</span></span>'
--   else
--      return '<span background="'..base3..'" font="Menlo 12"><span color="'..violet..'">'..larrow..'</span></span><span background="'..violet..'" font="Menlo 12"><span font="Menlo 10" color="'..base2..'">'..musicicon.. ' '.. args["{Title}"]..'</span></span><span background="'..violet..'"><span color="'..blue..'" font="Menlo 12">'..larrow..'</span></span>'
...
vicious.register(volwidget, vicious.widgets.volume, '<span background="'..violet..'" font="Menlo 12"><span font="Menlo 10" color="'..base2..'">$2 $1% </span></span><span background="'..violet..'"><span color="'..blue..'" font="Menlo 12">'..larrow..'</span></span>', .5, "Master")
...
vicious.register(clockwidget, vicious.widgets.date, '<span background="'..magenta..'" font="Menlo 12" color="'..base01..'">'..larrow..'</span><span background="'..base01..'" font="Menlo 10" color="'..base2..'"> %b %d <span font="Mensh 12">'..lthinsep..'</span> %I:%M </span>', 60)
...
vicious.register(cpuwidget, vicious.widgets.cpu,
                 '<span background="'..base03..'" font="Menlo 12"><span color="'..blue..'"> '..larrow..'</span></span><span background="'..blue..'" font="DejaVu Sans Mono 12"> <span font="DejaVu Sans Mono 10" color="'..base2..'"><span font="DejaVu Sans Mono 12">'..cpu..'</span> $2% <span color="'..base03..'">·</span> $3% <span color="'..cyan..'" font="DejaVu Sans Mono 12">'..larrow..'</span></span></span>', 5)
...
'<span background="'..orange..'" font="Menlo 12"> <span font="Menlo 10" color="'..base2..'"><span font="Menlo 12">'..hdd..'</span> ${/home avail_gb}GB <span color="'..violet..'" font="Menlo 12">'..larrow..'</span></span></span>', 8)
...
vicious.widgets.net,
'<span background="'..cyan..'" font="Menlo 12"> <span font="Menlo 10" color="'..base2..'"><span font="Menlo 12">'..wifi..'</span> ${eno1 down_kb} ↓↑ ${eno1 up_kb} <span color="'..magenta..'" font="Menlo 12">'..larrow..'</span></span></span>', 3)
...
vicious.register(memwidget, vicious.widgets.mem, '<span background="'..magenta..'" font="Menlo 12"> <span font="Menlo 10" color="'..base2..'" background="'..magenta..'"><span font="Menlo 12">'..mem..'</span> $2MB </span></span>', 3)
...
separator:set_markup('<span font="Mensh 12">'..rthinsep..' </span>')


--{{---| Menu |-------------------------------------------------------------------------------------

myawesomemenu = {
  {"edit awesome",           "subl /home/ubercow/.config/awesome/"},
...
mymainmenu = awful.menu({ items = {
  ...
  {" xfce4-terminal",             "xfce4-terminal", beautiful.terminal_icon},
  {" lilyterm",             "lilyterm", beautiful.terminal_icon}
}
})
