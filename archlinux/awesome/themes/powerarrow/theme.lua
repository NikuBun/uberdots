...
theme.titlebar_bg_focus                     = "#b58900"
theme.titlebar_bg_normal                    = "#b58900"
theme.taglist_fg_focus                      = "#b58900"
theme.textbox_widget_as_label_font_color    = white 
theme.textbox_widget_margin_top             = 1
theme.text_font_color_1                     = base0
theme.text_font_color_2                     = base1
theme.text_font_color_3                     = base01
theme.notify_font_color_1                   = red
theme.notify_font_color_2                   = orange
theme.notify_font_color_3                   = green
theme.notify_font_color_4                   = yellow
theme.notify_font                           = "DejaVu Sans Mono 10"
theme.notify_fg                             = theme.fg_normal
theme.notify_bg                             = theme.bg_normal
theme.notify_border                         = theme.border_focus
theme.awful_widget_bckgrd_color             = base03
theme.awful_widget_border_color             = base03
theme.awful_widget_color                    = base02
theme.awful_widget_gradien_color_1          = base03
theme.awful_widget_gradien_color_2          = base03
theme.awful_widget_gradien_color_3          = base03
